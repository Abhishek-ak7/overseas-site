...
const defaultPosts: BlogPost[] = [
  {
    ...
    excerpt: 'Everything you need to know about studying in Canada, from university selection to visa requirements and living expenses.',
    content: '',
    featuredImageUrl: '/news-1.jpg',
    authorName: 'Sarah Johnson',
    authorAvatar: '/young-woman-professional-headshot.png',
  ...
  },
  {
    ...
    content: '',
    featuredImageUrl: '/news-2.jpg',
    authorName: 'Dr. Michael Chen',
    authorAvatar: '/young-man-professional-headshot.png',
  ...
  },
  {
    ...
    content: '',
    featuredImageUrl: '/news-3.jpg',
    authorName: 'Emma Wilson',
    authorAvatar: '/professional-headshot-of-young-asian-woman.jpg',
